        ...
        <p>Last Name:
            ...
            <p>Email:
                ...
                <p>Summary:</p>
                    ...
                    <input type="text" name="summary" size="50" value="<?= $su ?>">
                    
                    <!-- 
                    <p>
                    <textarea form="testformid" "rows="15" cols="50" value="<?= $su ?>"></textarea>
                    </p>
                    -->
                    ...
                    <button type="button"><a href="index.php" style="color: black; text-decoration: none;">Cancel</a>
                    </button>
                    </p>
